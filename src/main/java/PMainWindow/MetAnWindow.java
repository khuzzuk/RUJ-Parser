...
public class MetAnWindow extends JFrame implements CSVDataHolder
{
	...
	{
		JMenuItem goToURL = new JMenuItem("Otwórz rekord w przeglądarce");
		...
		JMenuItem dcContributorMenu = new JMenuItem("Zamień twórców");
		dcContributorMenu.addActionListener(new Change_Contributors());
		JMenuItem listAffiliations = new JMenuItem("Pokaż afiliacje");
	...
	private void createMenu()
	{
		...
		menuItems[2] = new JMenuItem("Wyjdź");
		...
		menuItems[8] = new JMenuItem("dodaj ID artykułu");
		...
		menuItems[16] = new JMenuItem("Rekordy wydziały");
		menuItems[17] = new JMenuItem("Serie punktowane");
		menuItems[18] = new JMenuItem("Sprawdź indeksowanie Scopus (wszystkie rekordy)");
		menuItems[19] = new JMenuItem("Sprawdź indeksowanie Web of Science (wszystkie rekordy)");
		menuItems[20] = new JMenuItem("Tabelka dla pól OpenAccess");
		menuItems[21] = new JMenuItem("Wczytaj xml");
		menuItems[22] = new JMenuItem("Sprawdź problemy z afiliacji");
		menuItems[23] = new JMenuItem("Napraw listę SAP");
		menuItems[24] = new JMenuItem("Sprawdź pole \"admin\"");
		menuItems[25] = new JMenuItem("Sprawdź indeksowanie konferencji");
	...
	private void createToolBar()
	{
		...
		toolbarButtons[3].setToolTipText("Zamień role twórców");
		toolbarButtons[4].setToolTipText("Sprawdź indeksowanie konferencji");
	...
	private void addListenerToMenu()
	{
		...
		menuItems[4].addActionListener(new lookForJournals("Znajdź po ISSN"));
		menuItems[5].addActionListener(new metadataFind("Metadane"));
		menuItems[6].addActionListener(new changeToJournal("Zamień na czasopismo"));
		menuItems[7].addActionListener(new changeToSeries("Zamień na serie"));
	...
	public void checkConferenceIndexing(){
		...
		String confTitle = JOptionPane.showInputDialog("Podaj nazwę konferencji albo tytuł książki lub serii (Web of Science)");
		String a = "nie";
		String b = "nie";
